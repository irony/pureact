...
var _libLstore2 = _interopRequireDefault(_libLstore);
...
var _vtreeDiff2 = _interopRequireDefault(_vtreeDiff);

var _vdomPatch = require('vdom/patch');

var _vdomPatch2 = _interopRequireDefault(_vdomPatch);

var _vdomCreateElement = require('vdom/create-element');

var _vdomCreateElement2 = _interopRequireDefault(_vdomCreateElement);

var _vtreeVtext = require('vtree/vtext');

var _vtreeVtext2 = _interopRequireDefault(_vtreeVtext);

var _vtreeVnode = require('vtree/vnode');

var _vtreeVnode2 = _interopRequireDefault(_vtreeVnode);
...
var dom = {
  vtree: function vtree(tree) {
    if (!tree.tagName) return new _vtreeVtext2['default'](tree);
    ...
    return new _vtreeVnode2['default'](tree.tagName, props, children);
  },
  render: function render(tree, node) {
    var before = new Date();
    var vtree = dom.vtree(tree);
    if (lastTree) {
      var patches = (0, _vtreeDiff2['default'])(lastTree, vtree);
      console.log('applied ' + Object.keys(patches).length + ' patches');
      node = (0, _vdomPatch2['default'])(rootNode, patches);
      lastTree = vtree;
    } else {
      rootNode = (0, _vdomCreateElement2['default'])(vtree);
